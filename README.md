...
- 출력
  - [o] 실행 결과를 출력해준다.
  - [o] 최종 우승자의 자동차를 출력해준다.
  - [o] 입력에 대한 안내사항을 출력해준다.

- 기능
  - [o] 값에 대한 조건이 일치하면 전진을 한다.
  - [o] 우승자가 누구인지 비교해주는 기능을 구현한다.

### 예외사항
- [o] 자동차의 이름은 쉼표로 구분한다.
- [o] 자동차가 없으면 안된다.
- [o] 자동차의 이름길이는 1자 이상 5자 이하여야한다.
- [o] 전진하기 위해 랜덤 값은 0에서 9 사이의 숫자여야 한다.
- [o] 우승자는 한 명 이상이어야 한다.
- [o] 시도할 횟수는 1이상의 숫자로 입력받아야합니다.
